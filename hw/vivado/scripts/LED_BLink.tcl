...
#
# LED_BLink.tcl: Tcl script for re-creating project 'LED_BLink'
#
# Generated by Vivado on Sun Feb 08 17:52:03 +0100 2026
...
#
# 1. This project restoration tcl script (LED_BLink.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "D:/Master_Thesis/LED_BLink/LED_BLink.srcs/constrs_1/new/zybo_led.xdc"
#    "D:/Master_Thesis/LED_BLink/LED_BLink.srcs/utils_1/imports/synth_1/design_LED_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../../../../Master_Thesis/LED_BLink/LED_BLink.srcs/constrs_1/new/zybo_led.xdc"]"\
 "[file normalize "$origin_dir/../../../../../Master_Thesis/LED_BLink/LED_BLink.srcs/utils_1/imports/synth_1/design_LED_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set orig_proj_dir "[file normalize "$origin_dir/../../../../../Master_Thesis/LED_BLink"]"
...
set_property -name "platform.name" -value "zybo_led_platform" -objects $obj
...
set_property -name "top" -value "design_LED_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../../../../../Master_Thesis/LED_BLink/LED_BLink.srcs/constrs_1/new/zybo_led.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/zybo_led.xdc"
...
set file "synth_1/design_LED_wrapper.dcp"
...
# Proc to create BD design_LED
proc cr_bd_design_LED { parentCell } {
...
\
  ...
  set_property PFM_NAME {xilinx:zybo-z7-20:zybo_led_platform:1.0} [get_files [current_bd_design].bd]
  set_property PFM.AXI_PORT {M_AXI_GP0 {memport "M_AXI_GP" sptag "" memory "" is_range "false"}} [get_bd_cells /processing_system7_0]
  set_property PFM.CLOCK {FCLK_CLK0 {id "0" is_default "true" proc_sys_reset "/proc_sys_reset_0" status "fixed" freq_hz "50000000"}} [get_bd_cells /processing_system7_0]
...
# End of cr_bd_design_LED()

cr_bd_design_LED ""
set_property PFM_NAME "xilinx:zybo-z7-20:zybo_led_platform:1.0" [get_files design_LED.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files design_LED.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files design_LED.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list design_LED.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../../../../Master_Thesis/LED_BLink/LED_BLink.gen/sources_1/bd/design_LED/hdl/design_LED_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list design_LED.bd]] -top]
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/${_xil_proj_name_}.srcs/utils_1/imports/synth_1/design_LED_wrapper.dcp" -objects $obj
